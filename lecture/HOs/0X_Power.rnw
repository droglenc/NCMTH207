%===============================================================================
% swv2PDF("0X_Power.rnw",createScript=FALSE)
%===============================================================================
% Overall Sweave and R options
%-------------------------------------------------------------------------------
\SweaveOpts{engine=R,eps=FALSE,pdf=TRUE,strip.white=true,keep.source=TRUE,prefix.string=Figs/pwr}
...
\begin{document}
\titleRHO{Statistical Power Analysis}{MTH207 Biometry}{Winter}
...
<<label=T1calc1,fig=TRUE,include=FALSE>>=
ns <- seq(10,100,1)
...
@
\includegraphics[width=4in]{Figs/pwr-T1calc1.PDF}
...
<<label=T1calc2,fig=TRUE,include=FALSE>>=
...
@
\includegraphics[width=4in]{Figs/pwr-T1calc2.PDF}
...
<<label=T2calc1,fig=TRUE,include=FALSE>>=
...
@
\includegraphics[width=4in]{Figs/pwr-T2calc1.PDF}
...
<<label=T2calc2,fig=TRUE,include=FALSE>>=
ns <- seq(5,50,5)
...
@
\includegraphics[width=4in]{Figs/pwr-T2calc2.PDF}
...
Fourth, observe the obtained power values as a table (results not shown),
<<eval=FALSE>>=
rownames(power.1) <- bs
...
<<label=Slopecalc2,fig=TRUE,include=FALSE,eval=FALSE>>=
...
abline(v=-10,col="red",lwd=2,lty=2)
@
\includegraphics[width=6in]{Figs/pwr-Slopecalc2.PDF}
