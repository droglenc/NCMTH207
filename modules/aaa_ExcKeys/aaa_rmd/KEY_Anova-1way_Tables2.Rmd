...
<strong>Note:</strong> 
<ul>
<li>MS<sub>Total</sub> is not usually shown in an ANOVA table). I put it in the table here because that is one of the given values (see the notes below) and it makes it easier to see how the rest of the table is completed.</li>
</ul>
</div>
