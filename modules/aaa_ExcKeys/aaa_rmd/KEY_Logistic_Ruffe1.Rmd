...
1. The probabiilty that a 6-mm long larval ruffe had consumed a *Daphnia* is `r formatC(p6,format="f",digits=4)`. This means that approximately one out of every `r formatC(1/p6,format="f",digits=1)` 6-mm long larval ruffe will have consumed a *Daphnia*.
