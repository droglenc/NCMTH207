...
1. Yes there is evidence for a significant statistical change in the proportion of male births over the study period because the p-value for the slope (and the equivalent overall F p-value) is very small (`r kPvalue(sum1$coefficients["year","Pr(>|t|)"],digits=3,latex=FALSE)`; `r tbls("coef",display="cite")`). The relationship is illustrated in `r figs("fitplot",display="cite")`.
