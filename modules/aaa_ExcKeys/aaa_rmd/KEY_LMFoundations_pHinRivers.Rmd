...
1. The SE for the difference in means is equal to $\frac{{\bar x_1  - \bar x_2 }}{t}$ = $\frac{8.662-6.408}{6.9849}$ = 0.3227. The pooled variance is then equal to this value squared and divided by the sum of the reciprocals of the sample sizes -- i.e., $\frac{{SE_{\bar x_1  - \bar x_2 }^2 }}{{{\textstyle{1 \over {n_1 }}} + {\textstyle{1 \over {n_2 }}}}}$ = $\frac{0.3227^{2}}{{{\textstyle{1 \over 10}} + {\textstyle{1 \over 10}}}}$ = 0.5207.
