...
1. The SE for the difference in means is equal to $\frac{\bar{x_{1}}-\bar{x_{2}}}{t}$ = $\frac{8.662-6.408}{6.9849}$ = 0.3227. The pooled variance ($s_{p}^{2}$) is then equal to this value squared ($0.3227^{2}$ = 0.1041) and divided by the sum of the reciprocals of the sample sizes -- i.e., $\frac{0.3227^{2}}{\frac{1}{10}+\frac{1}{10}}$ = 0.5207.
