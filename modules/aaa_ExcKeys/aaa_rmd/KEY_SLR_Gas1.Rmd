...
<strong>Note:</strong> 
<ul>
  <li>In the first question, "coefficients" simply refer to the parameter estimates under the "Est" column heading. No other value in the table from `summary()` is considered a coefficient.</li>
</ul>
</div>
