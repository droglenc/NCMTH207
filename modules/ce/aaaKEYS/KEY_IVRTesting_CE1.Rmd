...
<strong>Note:</strong> 
<ul>
  <li>Make sure to include the $\mu$ part on the left-hand-side of yoru models.</li>
</ul>
</div>
...
<ul>
  <li>Make sure to include the $\mu$ part on the left-hand-side of yoru models.</li>
  <li>The parallel lines test indicates that ALL of the lines are statistically parallel.</li>
  <li>The coincident lines test indicates that SOME of the lines are not coincident.</li>
  <li>When plotting the lines without any data then the y-axis label should include "mean."</li>
</ul>
</div>
