...
## Knit first, then this renders an HTML file and moves to CE directory
source("modules/ce/aaaKeys/zzz_modHTML_CEKeys.R")
modHTML_CEKeys("KEY_LogRegSummary_CE1",need2render=FALSE)
```
...
btslp <- exp(c(Ests=0.04063362,
               "95% LCI"=0.03459031,"95% UCI"=0.04710694))
