...
1. The back-transformed mean of the measurement variable for the "A" group is `r formatC(mcsum1bt$emmeans$emmean[1],format="f",digits=2)` (=`r formatC(mcsum1t$emmeans$emmean[1],format="f",digits=2)`<sup>2</sup>).
...
1. The back-transformed mean of the measurement variable for the "C" group is `r formatC(mcsum2bt$emmeans$response[1],format="f",digits=2)` (=e<sup>`r formatC(mcsum2t$emmeans$emmean[1],format="f",digits=2)`</sup>).
1. The mean of the measurement variable for the "B" group is `r formatC(mcsum2bt$contrasts$ratio[3],format="f",digits=3)` as large as the mean for the "C" group. Alternatively, the mean of the measurement variable for the "C" group is `r formatC(1/mcsum2bt$contrasts$ratio[3],format="f",digits=3)` times larger than the mean for the "B" group.
...
1. The back-transformed mean concentration of iron in streams in the unmined basin is `r formatC(mcsum3bt$emmeans$response[1],format="f",digits=3)` mg/L (=e<sup>`r formatC(mcsum3t$emmeans$emmean[1],format="f",digits=3)`</sup>).
...
1. The mean concentration of iron in streams in the unmined basin was `r formatC(mcsum3bt$contrasts$ratio[2],format="f",digits=3)` as large as the mean concentration of iron in streams in the basin with abandoned mines. Alternatively, mean concentration of iron in streams in the basin with abandoned mines was `r formatC(1/mcsum3bt$contrasts$ratio[2],format="f",digits=3)` as large as the mean concentration of iron in streams in the unmined basin.
