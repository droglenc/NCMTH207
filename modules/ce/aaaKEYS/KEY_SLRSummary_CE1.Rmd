...
A total of `r n` bears were examined for this study. There is not nearly enough information in the background to fully address the independence assumption, but it is unlikely that the weight of any one bear will have much of an impact on any other bear, let alone have an impact on all other bears. Thus, the independence assumption is adequately met.
