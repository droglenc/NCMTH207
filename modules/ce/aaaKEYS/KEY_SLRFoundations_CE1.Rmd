...
1. The predicted proportion of males in 1990 is `r formatC(predict(lm.br,data.frame(year=2000)),format="f",digits=4)`.
1. The predicted proportion of males in 1990 is `r formatC(predict(lm.br,data.frame(year=2000)),format="f",digits=4)`. This value should be interpreted cautiously as it is an extrapolation.
1. The residual for 1980 is `r formatC(0.5129-predict(lm.br,data.frame(year=2000)),format="f",digits=4)` (=0.5129-`r formatC(predict(lm.br,data.frame(year=1980)),format="f",digits=4)`).
