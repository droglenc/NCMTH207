...
1. The predicted proportion of males in 2020 is `r formatC(predict(lm.br,data.frame(year=2020)),format="f",digits=4)`. This value should be interpreted cautiously as it is an extrapolation (there is no reason to believe that the line will extend out to 2020).
