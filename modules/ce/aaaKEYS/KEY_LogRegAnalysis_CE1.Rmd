...
1. There is a significant relationship between whether or not the Ruffe consumed a *Daphnia* and the length of the Ruffe (LRT `r aov.p.Ruffe`).
...
1. The odds that a 6-mm Ruffe will have consumed a *Daphnia* is `r formatC(odds6,format="f",digits=3)`. Thus, the probability that 6-mm Ruffe will have consumed a *Daphnia* is `r formatC(odds6,format="f",digits=3)` times as likely than it not having consumed a *Daphnia*.
1. The probability that a 6-mm Ruffe will have consumed a *Daphnia* is between `r formatC(prob6.ci[1],format="f",digits=3)` and `r formatC(prob6.ci[2],format="f",digits=3)`.
