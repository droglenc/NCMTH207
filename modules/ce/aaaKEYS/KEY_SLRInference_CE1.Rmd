...
1. The predicted wing length for a bird that migrated on day 160 is between `r formatC(pi.160["lwr"],format="f",digits=1)` and `r formatC(pi.160["upr"],format="f",digits=1)` mm. This is about a bird, so this uses a "prediction interval."
1. The predicted mean wing length for all birds that migrated on day 160 is between `r formatC(ci.160["lwr"],format="f",digits=1)` and `r formatC(ci.160["upr"],format="f",digits=1)` mm. This is about all birds, so this uses a "confidence interval."
...
1. The predicted mean mpg for all makes of car with horsepower of 110 is between `r formatC(ci.110["lwr"],format="f",digits=1)` and `r formatC(ci.110["upr"],format="f",digits=1)`. This is about all makes of cars, so this uses a "confidence interval."
1. The predicted mpg for a make of car with a horsepower of 125 is between `r formatC(pi.125["lwr"],format="f",digits=1)` and `r formatC(pi.125["upr"],format="f",digits=1)` mm. This is about a car, so this uses a "prediction interval."
