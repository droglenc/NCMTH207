...
1. Hand draw an interaction plot with the factor that has levels W and Z on the x-axis.
...
<ol>
  <li>Figure 1. <span style="font-size:150%">&#8628;</span></li>
</ol>
...
<ol start="2">
  <li>Figure 2. <span style="font-size:150%">&#8628;</span></li>
</ol>
...
<ol start="3">
  <li>Figure 3. <span style="font-size:150%">&#8628;</span></li>
</ol>
...
<ol start="4">
  <li>Figure 4. <span style="font-size:150%">&#8628;</span></li>
</ol>
...
<ol start="5">
  <li>Figure 5. <span style="font-size:150%">&#8628;</span></li>
</ol>
...
<ol start="6">
  <li>Figure 6. <span style="font-size:150%">&#8628;</span></li>
</ol>
...
<ol>
  <li>Table 1. <span style="font-size:150%">&#8628;</span></li>
</ol>
...
knitr::kable(tmp5w,booktabs=TRUE) %>%
  kableExtra::kable_classic(full_width=FALSE,html_font="Cambria")
```
...
<ol start="2">
  <li>Table 2. <span style="font-size:150%">&#8628;</span></li>
</ol>
...
knitr::kable(tmp2w,booktabs=TRUE) %>%
  kableExtra::kable_classic(full_width=FALSE,html_font="Cambria")
```
...
<ol start="3">
  <li>Table 3. <span style="font-size:150%">&#8628;</span></li>
</ol>
...
knitr::kable(tmp6w,booktabs=TRUE) %>%
  kableExtra::kable_classic(full_width=FALSE,html_font="Cambria")
```
