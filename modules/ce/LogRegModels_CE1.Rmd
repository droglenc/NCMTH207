...
1. Predict the log odds of being a *cinereus* if the canine tooth height is 4 but only using your previous prediction and the estimated value of the slope.
1. Predict the odds of being a *cinereus* if the canine tooth height is 4 but only using your previous prediction and the estimated value of the exponentiated slope.
