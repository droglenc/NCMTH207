...
transChooser(lm1)
```
```{r echo=FALSE, out.width='5.5in'}
knitr::include_graphics("TCTeal1.jpg")
```
...
# Fish Energy Density
[Hartman and Brandt (1995)](http://www.tandfonline.com/doi/abs/10.1577/1548-8659%281995%29124%3C0347%3AEEDOF%3E2.3.CO%3B2) examined the relationship between energy density (J/g wet weight) and percent dry weight for four species of fish -- Bay Ancovy (*Anchoa mitchilli*), Bluefish (*Pomatomus saltatrix*), Striped Bass (*Morone saxatilis*), and Weakfish (*Cynoscion regalis*).  They wanted to describe the relationship between these two variables and determine if there were any differences among species.
...
knitr::include_graphics("TCFish1.jpg")
```
...
purl2("RHO_2020.Rmd",moreItems=c("source","modHTML","kGLHT","kANOVA","include_graphics"))
```
