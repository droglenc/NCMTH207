...
The p-value for the factor variable (`r kPvalue(anova(lm2)[2,5],latex=FALSE)`; i.e., the second line) is less than &alpha; and, thus, the H<sub>0</sub> for the equal intercepts test is rejected. Thus, there is a difference in intercepts among these three species. The following video explains what we should do to indentify which pairs of intercepts are different.
