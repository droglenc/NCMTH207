...
* [Initiate MSTeams Site](resources/MSTeams_Intro){:target="_blank"}
* [Initiate Gradescope Grading Site](prep/GetOrganized_Gradescope){:target="_blank"}

If you plan to use your own computer to run R/Rstudio then you should complete the following items before the first day of class. If you plan to use the college computers you do not need to do these items.
...
* [Read about R Notebooks](resources/Notebook_Intro){:target="_blank"}
