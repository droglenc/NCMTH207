...
# "Noise" Variances
MS<sub>Total</sub> and MS<sub>Within</sub> are measures of the variance ^[As discussed in the previous module, SS are not true variances until they are divided by their df and become mean-squares (MS).] of **individuals** around the grand mean and group means, respectively. Thus, MS<sub>Total</sub> measures the variance or "noise" around the full model, whereas MS<sub>Within</sub> measures the variance or "noise" around the simple model.
