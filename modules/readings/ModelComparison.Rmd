...
Table: (\#tab:ModelDifferences) Differences between the two model types.
...
```{r Fpvalue, echo=FALSE, fi.cap='An F distribution with 4 numerator and 20 denominator degrees-of-freedom. The shaded area demonstrates calculating a p-value for an F-ratio of 2.2.'}
dfA <- 4
dfW <- 20
...
knitr::kable(anova(aov),booktabs=TRUE,digits=4,
...
* The common variance about the mean ($s^{2}$) is given by MS<sub>Total</sub> (e.g., $=\frac{20.6756+4.6008}{1+18}$=1.3303).
