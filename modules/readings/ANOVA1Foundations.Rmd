...
The figures below show a visual for simple and full models and residuals from each. Note the similarity with figures from the [Model Comparison module](ModelComparison.html), except that there are three group means here.
...
An ANOVA table is use to display the results from a one-way ANOVA, because the one-way ANOVA is simply a comparison of two models.
