...
<aside>The equal variance assumption is tested with Levene's test. P-values less than &alpha; indicate that the variances are not equal and the assumption was violated.
</aside>

\[ \begin{split}
   H_{0}&: \sigma_{1}^{2}=\sigma_{2}^{2}=\cdots=\sigma_{I}^{2} \\
   H_{A}&:\text{At least one pair of variances differ}
\end{split} \]
