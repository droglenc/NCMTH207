...
The five methods that will be covered in this course can be distinguished by considering only the type of response variable and the types and number of explanatory variables (Table \@ref(tab:ModelCharacteristics)). Thus, you will want to review [variable types](http://derekogle.com/NCMTH107/modules/FoundationalDefns.html) and [definitions and distinctions of response and explanatory variables](http://derekogle.com/NCMTH107/modules/DataProduction.html) from your introductory statistics course.

Table: (\#tab:ModelCharacteristics) Response and explanatory variables types for the linear models considered in this course.
...
```{r OneWay, fig.cap="Mean mirex concentration by sample year. This is an example of a One-Way ANOVA."}
...
```{r TwoWay, fig.cap="Mean mirex concentration by sample year and salmon species. This is an example of a Two-Way ANOVA."}
...
```{r SLR, fig.cap="Mirex concentration by fish weight. This is an example of a Simple Linear Regression."}
...
```{r IVR, fig.cap="Mirex concentration by fish weight seprated by salmon species. This is an example of an Indicator Variable Regression."}
...
```{r LogReg, fig.cap="The probability that the mirex concentration exceed the 0.1 mg/kg threshold by fish weight. This is an example of a Logistic Regression."}
