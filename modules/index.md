  ...
  <div class="panel panel-default">
    ...
    <div id="collapseLogisticR" class="panel-collapse collapse">
      ...
      <ul>
        ...
        <li><b>Exercises</b></li>
          <ol>
            <li><a href="LogisticRegression/EX_LogisticFlyingFox.html">Computations -- FlyingFox</a> <button type="button" class="btn btn-light btn-sm btn-space"><a href="aaa_ExcKeys/KEY_Logistic_FlyingFox.html" target="_blank">Answer</a></button></li>
