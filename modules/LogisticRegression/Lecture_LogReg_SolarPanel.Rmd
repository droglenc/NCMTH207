...
```
  ...
  <ul>
    <li>The offer will be accepted by 25% of the residents when their family income is $`r formatC(1000*x25,format="f",digits=0)`, with a 95% confidence interval from $`r formatC(1000*x25ci[1],format="f",digits=0)` to $`r formatC(1000*x25ci[2],format="f",digits=1)`.</li>
  </ul>
