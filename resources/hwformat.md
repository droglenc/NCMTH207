...
I have very specific expectations for your homework assignment reports.  These expectations and requirements are described below.  [A document that demonstrates several of these expectations is here](http://derekogle.com/NCMTH207/Resources/FAQ/FAQs/HWFormat_Example.pdf){:target="_blank"} (note the comments in "balloons").
...
1. Each document should be labeled with your name and homework title (e.g., "Module 1 Homework").  It is not important to include the name of the class or my name (I already know both of these).
...
1. Generally, the document should be single-spaced (see [this FAQ for making MSWord "single space" your document](http://derekogle.com/NCMTH207/Resources/FAQ/FAQs/Word_SingleSpace)).
...
1. R/RStudio output (usually as a table) should be converted to "Courier" or "Courier (New)" font.  This is the font used by R/RStudio and, thus, will force the items in the table to "line up." This will save you from having to include spaces or tabs to make items line up.  See [this FAQ](http://derekogle.com/NCMTH207/Resources/FAQ/FAQs/Word_RLineup) on how to change the font.  ONLY R/RStudio output should be in the "Courier" font.  All other text should be in the fonts mentioned previously.
1. Where appropriate, Greek letters should be changed to their symbol equivalent.  In other words, it is better to use &alpha; than "alpha."  See [this FAQ](http://derekogle.com/NCMTH207/Resources/FAQ/FAQs/Word_GreekLetters) for how to include these symbols in your analysis.
